...
/**
 * Renders the disease surveillance summary report: one row per category/diagnosis combination,
 * with a merged category cell spanning every diagnosis in that category. Same shape as
 * {@link SummaryReportController}, sourced from encounter_diagnosis instead of lab orders.
 */
@Controller
@RequestMapping("/module/labtestreport/diseaseSummary.form")
public class DiseaseSummaryReportController {
	...
	public void initBinder(HttpServletRequest request, ServletRequestDataBinder binder) {
		binder.registerCustomEditor(Date.class, new CustomDateEditor(new SimpleDateFormat(SummaryReportController.DATE_FORMAT), true));
	}
	...
	public ModelAndView showReport(
		...
		return new ModelAndView("/module/labtestreport/diseaseSummaryReport", model);
	}
}
