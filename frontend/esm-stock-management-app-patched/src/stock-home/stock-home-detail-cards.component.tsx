...
import StockHomeNearingStockoutCard from './stock-home-nearing-stockout-card.component';
...
const StockHomeDetailCards: React.FC = () => {
  ...
  return (
    <div className={styles.cardContainer}>
      ...
      <DetailCard title={t('itemsNearingStockout', 'Items nearing stockout')}>
        <StockHomeNearingStockoutCard />
      </DetailCard>
    </div>
  );
};
