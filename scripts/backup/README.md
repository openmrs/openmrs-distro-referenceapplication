...
Scripts para respaldar y restaurar la base de datos MariaDB de peruHCE.
...
# Restore directo
./scripts/backup/restore_dump.sh --file ~/peruHCE-dumps/dump_2026-03-09.sql.gz
```
...
```
--container NOMBRE    Contenedor DB (default: peruHCE-db-master)
