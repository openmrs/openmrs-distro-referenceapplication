...
public class ClinicianFacingPatientDashboardPage extends Page {
    ...
    private static final By APPOINTMENT_EDIT = By.cssSelector("#content > div.dashboard.clear.row > div.col-12.col-lg-9 > div > div:nth-child(1) > div:nth-child(7) > div.info-header > a > i");
