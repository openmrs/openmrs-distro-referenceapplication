...
public class StyleColorTest extends TestBase {
	...
	@Test
	public void patientAllergiesPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
	...
	@Test
	public void patientEditAllergyPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
	...
	@Test
	public void patientEditDemographicsPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
	...
	@Test
	public void patientEditContactInfoPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
	...
	@Test
	public void visitNotePageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
		
		assertPage(patientDashboardPage);
		patientDashboardPage.clickVisitAction(1);
		
		checkWebPageAllElementsColor();
	}
	
	@Test
	public void exitFromInpatientPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
		
		assertPage(patientDashboardPage);
		patientDashboardPage.clickVisitAction(2);
		
		checkWebPageAllElementsColor();
	}
	
	@Test
	public void transferToWardServicePageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
	...
	@Test
	public void mergeVisitsPageTest() {
		currentPage().gotoPage("/coreapps/findpatient/findPatient.page?app=coreapps.findPatient");
		findPatientRecordPage.clickFirstPatient();
		
		assertPage(patientDashboardPage);
		patientDashboardPage.clickGeneralAction(1);
	...
	@Test
	public void atlasPageTest() {
		currentPage().gotoPage("/atlas/map.page");
		checkWebPageAllElementsColor();
	}
