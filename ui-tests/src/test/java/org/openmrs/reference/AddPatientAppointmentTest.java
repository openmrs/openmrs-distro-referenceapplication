...
public class AddPatientAppointmentTest extends LocationSensitiveApplicationTestBase {
	...
	public void addPatientAppointmentTest() throws Exception {
		...
		homePage = new HomePage(login());
		FindPatientPage patientPage = homePage.goToFindPatientRecord();
		patientPage.enterPatient(patient.getName());
		patientPage.clickOnFirstPatient();
		assertNotNull(manageAppointmentsPage.checkAppointment());
