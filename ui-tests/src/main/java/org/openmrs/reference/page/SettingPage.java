...
public class SettingPage extends AbstractBasePage{
    ...
    public void chooseFalseDigit(){ clickOn(FALSE_DIGIT);}
    public void chooseTrueDigit(){
        clickOn(TRUE_DIGIT);
        clickOn(SAVE_PROPERTIES);
    }
    public void waitForMessage(){ waitForElement(MSG);}
    public void chooseFalseNonDigit(){ clickOn(FALSE_NONDIGIT);}
    public void chooseTrueNonDigit(){
        clickOn(TRUE_NONDIGIT);
        clickOn(SAVE_PROPERTIES);
    }
    public void chooseFalseCase(){ clickOn(FALSE_CASE);}
