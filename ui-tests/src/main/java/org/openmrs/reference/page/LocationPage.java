...
public class LocationPage extends AbstractBasePage {
	...
	public void clickOnLocation(int index) {
		List<WebElement> locationCollection = driver.findElements(By.xpath("id('sessionLocation')/li"));
		locationCollection.get(index).click();
	}
	
	public void clickOnLocation(String name) {
		WebElement location = driver.findElement(By.xpath("id('sessionLocation')/li[@id='" + name + "']"));
		location.click();
	}
