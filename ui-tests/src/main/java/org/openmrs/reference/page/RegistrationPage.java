...
public class RegistrationPage extends Page {
	...
	/* Tests should no longer use driver as a parameter to set up pages (according to guidelines)
	 * This only remains because so many other tests rely on it
	 * Comment by cards31 on 24/04/2016
	 */
	...
	public void enterPatient(TestPatient patient) throws InterruptedException{
		System.out.println(patient.givenName);
	...
	public void enterGenericPatient(TestPatient patient) throws InterruptedException{
    	// Name
	...
	/**
	 * Used for RA-472 test
	 * @param patient The patient whose gender will be used
	 * @throws InterruptedException Thrown by the "clickOn" methods
	 */
